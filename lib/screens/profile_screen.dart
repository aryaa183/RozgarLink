...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  /// ─────────────────────────
  /// 🔥 FIREBASE REVIEW FETCH
  /// ─────────────────────────
  Stream<List<WorkerReview>> getReviews() {
  ...
  /// 🧾 REVIEW CARD
  Widget _buildReviewItem(WorkerReview review) {
    return Container(
              ...
              background: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(user?.displayName ?? "Worker Profile",
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("Worker Reputation",
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),

                  const SizedBox(height: 15),

                  StreamBuilder<List<WorkerReview>>(
                    stream: getReviews(),
