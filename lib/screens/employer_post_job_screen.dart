...
class EmployerPostJobScreen extends StatefulWidget {
  @override
  _EmployerPostJobScreenState createState() =>
      _EmployerPostJobScreenState();
}

class _EmployerPostJobScreenState
    extends State<EmployerPostJobScreen> {
  ...
  Future<void> _postJob() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'body':
            '${_titleCtrl.text.trim()} job posted in ${_locationCtrl.text.trim()}',
